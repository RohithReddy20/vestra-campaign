    ...
    <>
      <div className="min-h-screen bg-[#0C0C0C] text-white pt-3">
        ...
        <div className="max-w-5xl mx-auto px-4 py-8 sm:py-8 text-center">
          ...
          <p className='font-alliance font-normal text-sm mb-8 sm:mb-5 md:mb-0 sm:text-base text-white leading-8 pt-4'>These predictions and resolutions are purely for entertainment purposes. No advice or insights should be taken seriously. Laugh responsibly!</p>
