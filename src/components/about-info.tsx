  ...
  return (
    <>
      <div className="flex relative flex-col items-center justify-center w-full py-4 px-3 sm:px-6">
        ...
        />
        <p className="text-white text-xl sm:text-2xl md:text-4xl font-tfnr font-medium text-center z-20">
          This agent is built by{' '}
          <span className="font-fauna text-xl sm:text-2xl sm:text-[28px] gradient-text font-thin">
            VESTRA
          </span>
        </p>
        <p className="font-tfnr text-base sm:text-lg md:text-3xl text-[#B8B8B8] text-center mt-4 sm:mt-6 z-20 max-w-4xl">
          Explore a vast library of pre-built agents and tools. Find ready-to-use solutions or get
          inspired to build your own.
        </p>
        <AgentsInfoCarousel />
      </div>
      <div className="footer flex flex-col sm:flex-row gap-y-6 sm:gap-x-16 justify-center items-center w-full pb-8 sm:pb-16">
        <div className="flex flex-col items-center justify-center  sm:justify-end md:gap-4 relative z-10">
        ...
        <div
          className="flex flex-col gap-8 sm:gap-10 w-full sm:w-[45%]"
          style={{ maxWidth: 'min(500px, 80%)' }}
        >
          <div className="space-y-3">
            <p className="font-tfnr text-xl sm:text-2xl md:text-3xl font-bold text-white">
              An Agent for every use case
            </p>
            <p className="font-tfnr text-[#BFBFBF] text-sm sm:text-base md:text-xl font-medium">
